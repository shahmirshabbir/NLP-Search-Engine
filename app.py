...
Provides:
  - a search box UI that prints the raw result paths (no image rendering)
...
def search(query: str, k: int) -> str:
    """
    Returns the raw {"results": {"0": "<url>", ...}} response as a
    pretty-printed JSON string (plain text output, no image rendering,
    no typed JSON component — avoids the schema-generation bugs those
    trigger on this gradio version).
    """
